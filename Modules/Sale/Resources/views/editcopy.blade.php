                                ...
                                <div class="col-lg-4">
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="customer_id" id="customer_id" required readonly>
                                ...
                                <div class="col-lg-4">
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="date" required value="{{ $sale->date }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
